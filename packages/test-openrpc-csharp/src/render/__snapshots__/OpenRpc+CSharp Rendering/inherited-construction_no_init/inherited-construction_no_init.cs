...
namespace generated.omnigen
{
    ...
    {
        public Method1Request(string id, Method1RequestParams @params) : base(id, "Method1", @params) { }
    }
    ...
    {
        public Method2Request(string id, Method2RequestParams @params) : base(id, "Method2", @params) { }
    }
