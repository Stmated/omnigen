...
public class Web3Sha3RequestParams extends JsonRpcRequestParams {
   ...
   *   <h2>sha3Example</h2>
   *   <ul>
   *     <li>{@code "0x68656c6c6f20776f726c64"}</li>
   *     <li>{@code "0x47173285a8d7341e5e972fc677286384f802f8ef42a5ec5f03bbfa254cb01fad"}</li>
   *   </ul>
   * </section>
   */
...
/**
 * <code>true</code> if listening is active or <code>false</code> if listening is not active
 */
@Generated(value = "omnigen", date = "2000-01-02T03:04:05.000Z")
...
/**
 * Network ID associated with the current network
 */
@Generated(value = "omnigen", date = "2000-01-02T03:04:05.000Z")
...
/**
 * BlockNumber: The hex representation of the block's heightNullBlockNumberTag: The optional block height description
 */
@Generated(value = "omnigen", date = "2000-01-02T03:04:05.000Z")
...
public class Transaction {
   ...
   * <p>Hex representation of a Keccak 256 hash</p>
   * <p>Null</p>
   */
   ...
   * <p>The hex representation of the block's height</p>
   * <p>Null</p>
   */
   ...
   * <p>Hex representation of the integer</p>
   * <p>Null</p>
   */
...
public class EthGetBlockByHashRequestParams extends JsonRpcRequestParams {
  ...
  /**
   * The hex representation of the Keccak 256 of the RLP encoded block<section>
   *   <h2>nullExample</h2>
   *   <ul>
   *     <li>{@code "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef"}</li>
   *     <li>{@code "0x0"}</li>
   *     <li>{@code null}</li>
   *   </ul>
   * </section>
...
public class Block {
   ...
   * <p>A number only to be used once</p>
   * <p>Null</p>
   */
  public String getNonce() {
    return this.nonce;
...
/**
 * transaction: NullTransactionHash: Keccak 256 Hash of the RLP encoding of a transaction
 */
@Generated(value = "omnigen", date = "2000-01-02T03:04:05.000Z")
...
/**
 * SchemasAddress: NullAddresses: List of contract addresses from which to monitor events
 */
@Generated(value = "omnigen", date = "2000-01-02T03:04:05.000Z")
...
/**
 * The filter ID for use in <code>eth_getFilterChanges</code>
 */
@Generated(value = "omnigen", date = "2000-01-02T03:04:05.000Z")
...
public class EthSubmitWorkRequestParams extends JsonRpcRequestParams {
  ...
  /**
   * The mix digest.<section>
   *   <h2>submitWorkExample</h2>
   *   <ul>
   *     <li>{@code "0x0000000000000001"}</li>
   *     <li>{@code "0x6bf2cAE0dE3ec3ecA5E194a6C6e02cf42aADfe1C2c4Fff12E5D36C3Cf7297F22"}</li>
   *     <li>{@code "0xD1FE5700000000000000000000000000D1FE5700000000000000000000000000"}</li>
   *     <li>{@code false}</li>
   *   </ul>
   * </section>
   */
  ...
  /**
   * Current block header PoW hash.<section>
   *   <h2>submitWorkExample</h2>
   *   <ul>
   *     <li>{@code "0x0000000000000001"}</li>
   *     <li>{@code "0x6bf2cAE0dE3ec3ecA5E194a6C6e02cf42aADfe1C2c4Fff12E5D36C3Cf7297F22"}</li>
