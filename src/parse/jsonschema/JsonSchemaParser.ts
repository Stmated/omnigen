 ...
 */
export class JsonSchemaParser<T extends JsonObject> {
  ...
  private readonly _deref: Dereferencer<T>;

  private readonly _options: RealOptions<IParserOptions>;

  constructor(deref: Dereferencer<T>, options: RealOptions<IParserOptions>) {
    this._deref = deref;
