...
import {OmniGenericSourceIdentifierType, OmniType, OmniTypeKind, TypeNode} from '@omnigen/core';
 ...
 */
export class ResolveGenericSourceIdentifiersAstTransformer extends AbstractJavaAstTransformer {
  ...
  private findSourceIdentifierMappings(n: Java.AbstractObjectDeclaration, stack: Map<OmniGenericSourceIdentifierType, OmniType>[]) {
