...
export interface AstTransformerArguments<TRoot extends AstRootNode, TOpt extends TargetOptions> {
  model: OmniModel;
  root: TRoot;
...
export interface AstTransformer<TRoot extends AstRootNode, TOpt extends TargetOptions> {
